...
<hr style="width: 100%">
<form action="addrPaymentAction.jsp" method="post">
 <div class="left-div">
 <h3>Enter Address</h3>
...
<div class="right-div">
<h3>Pay online on this sportslakshay@gmail.com</h3>
...
<button class="button" type="submit">Proceed to Bill <i class='far fa-arrow-alt-circle-right'></i></button>
